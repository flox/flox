...
{
  // Sentry reporting on Darwin will take more effort, including getting the Sentry libs
  // into nix, as well as looking at the backend needs (breakpad or inproc).
  // See https://github.com/flox/flox/issues/1056 for details.
  #ifndef __APPLE__ 
  std::string dsn;
