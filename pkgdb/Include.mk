...
libpkgdb_CXXFLAGS += '-DFLOX_PKGDB_VERSION="$(VERSION)"'
libpkgdb_CXXFLAGS += '-DSEMVER_PATH="$(SEMVER)"'
...
ifneq ($(DEBUG),)
ifeq (gcc,$(TOOLCHAIN))
EXTRA_CXXFLAGS += -ggdb3 -pg
EXTRA_LDFLAGS  += -ggdb3 -pg
else # Clang
EXTRA_CXXFLAGS += -g -pg
EXTRA_LDFLAGS  += -g -pg
...
pkgdb_CXXFLAGS = $(CXXFLAGS) $(EXTRA_CXXFLAGS)
pkgdb_CXXFLAGS += $(libpkgdb_CXXFLAGS) $(toml_CFLAGS) $(yaml_CFLAGS)

pkgdb_LDFLAGS  = $(LDFLAGS) $(EXTRA_LDFLAGS)
