 ...
 * @file run.cc
 *
 * @brief Implements the `flox run` subcommand.
 *
 *
 * -------------------------------------------------------------------------- */
...
//   Category category() override { return flox::catAdditional; }
...
//     void
//   run( ref<Store> store, Installables && installables ) override
//   {
//     auto outPaths = Installable::toStorePaths( getEvalStore()
//                                              , store
//                                              , Realise::Outputs
//                                              , OperateOn::Output
//                                              , installables
...
//     auto unixPath =
//       tokenizeString<Strings>( getEnv( "PATH" ).value_or( "" ), ":" );
...
//         auto propPath = store->printStorePath( path ) +
...
//   Category category() override { return flox::catLocal; }
...
//     Strings
//   getDefaultFlakeAttrPathPrefixes() override
//   {
...
//     void
//   run( ref<Store> store, ref<InstallableValue> installable ) override
//   {
