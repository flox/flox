...
stdenv.mkDerivation (
  {
    ...
    src = builtins.path {
      ...
      filter =
        ...
        let
          ...
          notIgnored = (!(builtins.elem bname ignores)) && (!(builtins.elem ext ignoredExts));
        in
    ...
    passthru = {
      ...
      devEnvs = envs // {
        ...
        NIXPKGS_TEST_REF = "github:NixOS/nixpkgs/" + "ab5fd150146dcfe41fda501134e6503932cc8dfd";
      };
