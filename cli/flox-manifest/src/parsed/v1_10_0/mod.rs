...
pub mod test {
    ...
    use crate::parsed::v1_10_0::package_descriptor::{
    ...
    pub fn manifest_without_install_or_include() -> impl Strategy<Value = ManifestV1_10_0> {
        (
            any::<KnownSchemaVersion>(),
            any::<Vars>(),
            any::<Option<Hook>>(),
            any::<Option<Profile>>(),
            any::<Options>(),
    ...
    fn catalog_manifest_rejects_unknown_fields() {
        ...
        let err = toml_edit::de::from_str::<ManifestV1_10_0>(&manifest)
    ...
    fn detect_catalog_manifest() {
        assert!(toml_edit::de::from_str::<ManifestV1_10_0>(CATALOG_MANIFEST).is_ok());
    }
    ...
    proptest! {
        #[test]
        fn manifest_does_not_serialize_null_fields(manifest in any::<ManifestV1_10_0>()) {
    ...
    fn parses_build_section() {
        ...
        let parsed = toml_edit::de::from_str::<ManifestV1_10_0>(build_manifest).unwrap();
    ...
    fn filter_services_by_system() {
        ...
        let parsed = toml_edit::de::from_str::<ManifestV1_10_0>(manifest).unwrap();
    ...
    fn generate_mock_manifest(entries: Vec<(&str, &str)>) -> ManifestV1_10_0 {
        let mut typed_manifest_mock = ManifestV1_10_0::default();
    ...
    //     let _ = ManifestV1_10_0::from_str(contents_default).unwrap();
    //     let _ = ManifestV1_10_0::from_str(contents_all).unwrap();
    //     let _ = ManifestV1_10_0::from_str(contents_specific).unwrap();
    // }
}
