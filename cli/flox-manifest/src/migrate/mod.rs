...
use crate::migrate::v1_17_0_to_v1_18_0::migrate_manifest_v1_17_0_to_v1_18_0;
...
pub(crate) fn migrate_typed_only(
    ...
    inner = loop {
        match inner {
            ...
            Parsed::V1_11_0(manifest_v1_11_0) => {
            ...
            Parsed::V1_17_0(manifest_v1_17_0) => {
                let migrated = migrate_manifest_v1_17_0_to_v1_18_0(manifest_v1_17_0)?;
                inner = Parsed::V1_18_0(migrated);
            },
            Parsed::V1_18_0(manifest_v1_18_0) => break Parsed::from_latest(manifest_v1_18_0),
        }
    };
    debug_assert_eq!(inner.schema_version(), KnownSchemaVersion::latest());
    let Parsed::V1_18_0(migrated_manifest) = inner else {
