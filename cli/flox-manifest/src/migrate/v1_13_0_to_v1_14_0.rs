...
///
/// This is a lossless migration: V1_14_0 adds an optional top-level
/// `description` field. All V1_13_0 manifests are valid V1_14_0 manifests with
/// `description: None`. Every other field is unchanged, so it is moved across
/// verbatim.
