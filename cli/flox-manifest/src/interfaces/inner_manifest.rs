...
impl InnerManifestMarker for ManifestV1_18_0 {}
...
impl GetInnerManifest<ManifestV1_12_0> for Manifest<Validated> {
    fn get_inner_manifest(&self) -> Option<&ManifestV1_12_0> {
        if let Parsed::V1_12_0(ref manifest) = self.inner.parsed {
            Some(manifest)
        } else {
            None
        }
    ...
    fn get_inner_manifest_mut(&mut self) -> Option<&mut ManifestV1_12_0> {
        if let Parsed::V1_12_0(ref mut manifest) = self.inner.parsed {
            Some(manifest)
        } else {
            None
        }
...
impl GetInnerManifest<ManifestV1_18_0> for Manifest<Validated> {
    fn get_inner_manifest(&self) -> Option<&ManifestV1_18_0> {
        if let Parsed::V1_18_0(ref manifest) = self.inner.parsed {
            Some(manifest)
        } else {
            None
        }
    ...
    fn get_inner_manifest_mut(&mut self) -> Option<&mut ManifestV1_18_0> {
        if let Parsed::V1_18_0(ref mut manifest) = self.inner.parsed {
            Some(manifest)
        } else {
            None
        }
...
impl GetInnerManifest<ManifestV1_12_0> for Manifest<TypedOnly> {
    fn get_inner_manifest(&self) -> Option<&ManifestV1_12_0> {
        if let Parsed::V1_12_0(ref manifest) = self.inner.parsed {
            Some(manifest)
        } else {
...
impl GetInnerManifest<ManifestV1_18_0> for Manifest<TypedOnly> {
    fn get_inner_manifest(&self) -> Option<&ManifestV1_18_0> {
        if let Parsed::V1_18_0(ref manifest) = self.inner.parsed {
            Some(manifest)
        } else {
...
impl GetInnerManifest<ManifestV1_18_0> for Manifest<Migrated> {
    fn get_inner_manifest(&self) -> Option<&ManifestV1_18_0> {
...
impl GetInnerManifest<ManifestV1_18_0> for Manifest<MigratedTypedOnly> {
    fn get_inner_manifest(&self) -> Option<&ManifestV1_18_0> {
        Some(&self.inner.migrated_parsed)
    }
