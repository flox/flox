...
pub(crate) struct FlakeInstallableToLock {
    pub(crate) install_id: String,
    pub(crate) descriptor: PackageDescriptorFlake,
...
/// using the `builtins.lockFlakeInstallable` primop.
///
...
mod tests {
    ...
    use flox_manifest::raw::{FlakePackage, PackageToInstall};
    use indoc::formatdoc;
    use url::Url;
