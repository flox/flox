...
use indoc::indoc;
use serde::de::Error;
use toml_edit::{self, Array, DocumentMut, InlineTable, Item, Key, Table, Value, Formatted};

use crate::models::environment::path_environment::InitCustomization;
use crate::data::System;

use super::typed_manifest::Manifest;
...
fn install_id_from_attr_path(attr_path: &str, descriptor: &str) -> Result<String, RawManifestError> {
