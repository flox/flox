...
pub mod types {
    ...
    impl ::std::convert::From<&PackageBuildInput> for PackageBuildInput {
        fn from(value: &PackageBuildInput) -> Self {
            value.clone()
        }
    }
    ///`PackageBuildList`
    ...
    ///      "type": "array",
    ///      "items": {
    ///        "$ref": "#/components/schemas/PackageBuild-Output"
    ///      }
    ///    }
    ///  }
    ///}
    ...
    pub struct PackageBuildList {
        pub items: ::std::vec::Vec<PackageBuildOutput>,
    }
    ...
    impl ::std::convert::From<&PackageBuildOutput> for PackageBuildOutput {
        fn from(value: &PackageBuildOutput) -> Self {
            value.clone()
        }
    }
...
*/
    ...
    >(
        ...
        catalog_name: &'a types::CatalogName,
        package_name: &'a types::PackageName,
        body: &'a types::PackageBuildInput,
    ) -> Result<
