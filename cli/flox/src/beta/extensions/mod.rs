...
//!
//! `flox extension install|list|remove` manages `flox-<name>` executables
//! installed from local directories into `flox.data_dir/extensions`, and
...
pub use manager::{install_local, list, remove};
