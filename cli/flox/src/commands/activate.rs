...
mod tests {
    ...
    /// A remote environment is the case where the prompt used to say the most:
    /// `bare_description` decorates it with the owner and `(local)`, which is
    /// the string DEV-44 reports as too long and unclear.
    #[test]
