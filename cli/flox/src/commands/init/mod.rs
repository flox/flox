...
impl Init {
    ...
    fn combine_customizations(customizations: Vec<InitCustomization>) -> InitCustomization {
        let mut custom_scripts: Vec<String> = vec![];
        ...
        for customization in customizations {
            ...
            if let Some(hook) = customization.hook_on_activate {
                custom_scripts.push(hook)
            }
        }

        let custom_script = (!custom_scripts.is_empty()).then(|| {
            formatdoc! {"
                # Autogenerated by Flox

                {}

                # End autogenerated by Flox", custom_scripts.join("\n\n")}
        });
        ...
        InitCustomization {
            hook_on_activate: custom_script,
            profile_common: None,
            profile_bash: None,
            profile_zsh: None,
            packages,
...
mod tests {
    ...
    fn test_combine_customizations() {
        let customizations = vec![
            InitCustomization {
                hook_on_activate: Some("script1".to_string()),
                profile_common: None,
                profile_bash: None,
                profile_zsh: None,
                packages: Some(vec![
            ...
            InitCustomization {
                hook_on_activate: Some("script2".to_string()),
                profile_common: None,
                profile_bash: None,
                profile_zsh: None,
                packages: Some(vec![
